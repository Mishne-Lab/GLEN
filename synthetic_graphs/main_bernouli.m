...
% load('graphs/bernoulli_weighted_normalized_graphs_er03_n20_offset-1-2_w2.mat');
load('graphs/bernoulli_weighted_normalized_graphs_sbm0401_n20_offset-1-2_w2.mat');
% load('graphs/bernoulli_weighted_normalized_graphs_ws201_n20_offset-1-2_w2.mat');
...
%%
for i = 5%1:length_alpha%1%
    for j = 4%1:length_beta
        beta = beta_cgl(j);
        % GL-SigRep
